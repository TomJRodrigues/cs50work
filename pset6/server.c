...
int main(int argc, char* argv[])
{
    ...
    while (true)
    {
        ...
        if (connected())
        {
            ...
            // ensure that request-target does not contain "
            ...
            if (strcmp("HTTP/1.1", requestLine[HTTP_VERSION]) != 0)
            {
                error(505);
                continue;
            }
            ...
            // declare query array size using ternary notation
            ...
            (
                absolutePath,
                requestLine[REQUEST_TARGET],
                queryInd - requestLine[REQUEST_TARGET]
            );
            absolutePath[queryInd - requestLine[REQUEST_TARGET]] = '\0';
            
            // ensure request-target [absolute path] contains a . (for file extension)
            ...
            // ensure path is readable/accessible
